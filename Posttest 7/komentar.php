...
<head>
    ...
    <link rel="stylesheet" href="styles/komentar.css">
...
<body>
    <main>
        <section id="komentar" class="komentar">
            ...
            <form action="proses_upload.php" method="post" enctype="multipart/form-data" class="form-komentar">
            ...
            <button type="submit">Kirim Komentar dan Upload File</button>
</form>
